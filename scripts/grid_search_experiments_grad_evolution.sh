...
for nonlinearity_type in 'softplus' 'relu'
do
                ...
                do
                    ...
                    do
                        python main.py advection \
                            --tag advect1D_positional_harmonics_${N_harmonics}_nonlin_${nonlinearity_type}_${N_harmonics}_omega0_${i_omega0}_width_${i_n_width}_hidden_${i_hidden_layers}_lr_${i_learning_rate}\
                            --init_cond example1 \
