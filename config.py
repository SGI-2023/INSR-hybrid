...
class Config(object):
    ...
    def _add_training_config_(self, parser):
        ...
        group.add_argument('--max_n_iters', type=int, default=40000, help='number of iterations to train every time step')
        group.add_argument('--early_stop_accum_step', type=int, default=20000, help='after how many iterations without improvement to stop training')
